...
CMakeFiles/distclean:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/peach/Desktop/Yinuo/aspect-2.1-Vis-Depth/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "distclean invoked"
	/usr/local/pylith-2.2.1-linux-x86_64/bin/cmake --build /home/peach/Desktop/Yinuo/aspect-2.1-Vis-Depth/build --target clean
	/usr/local/pylith-2.2.1-linux-x86_64/bin/cmake -E remove_directory CMakeFiles
	/usr/local/pylith-2.2.1-linux-x86_64/bin/cmake -E remove CMakeCache.txt cmake_install.cmake Makefile build.ninja rules.ninja .ninja_deps .ninja_log
